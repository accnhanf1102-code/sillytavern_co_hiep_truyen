...
function showBlackjackGame() {
    ...
    gameUrl = `https://accnhanf1102-code.github.io/sillytavern_co_hiep_truyen/blackjack.html?money=${playerStats.金钱}`;
...
function showBattleGame(battleData) {
    ...
    const gameUrl = `https://accnhanf1102-code.github.io/sillytavern_co_hiep_truyen/turn-based-battle.html?${params.toString()}`;
...
function showFarmGame() {
    ...
    const gameUrl = `https://accnhanf1102-code.github.io/sillytavern_co_hiep_truyen/farm.html?${params.toString()}`;
...
function showAlchemyGame() {
    ...
    // 使用本地URL进行调试
    const gameUrl = `https://accnhanf1102-code.github.io/sillytavern_co_hiep_truyen/alchemy.html?${params.toString()}`;
